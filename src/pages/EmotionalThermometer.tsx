...
const AFFECTIVE_CATEGORIES = [
  { emoji: "🤩", label: "Admiración", value: "admiration", description: "Valoración positiva de una cualidad en otro" },
  { emoji: "🥰", label: "Adoración", value: "adoration", description: "Afecto intenso, casi reverencial, hacia algo o alguien" },
  { emoji: "😍", label: "Apreciación estética", value: "aesthetic_appreciation", description: "Placer ante la belleza o excelencia formal" },
  { emoji: "😄", label: "Diversión", value: "amusement", description: "Humor positivo" },
  { emoji: "😡", label: "Enojo", value: "anger", description: "Respuesta ante obstáculo o injusticia percibida" },
  { emoji: "😰", label: "Ansiedad", value: "anxiety", description: "Anticipación amenazante, difusa o específica" },
  { emoji: "😲", label: "Asombro reverencial", value: "awe", description: "Asombro ante algo vasto o que supera las expectativas previas" },
  { emoji: "😬", label: "Incomodidad social", value: "awkwardness", description: "Torpeza situacional" },
  { emoji: "😑", label: "Aburrimiento", value: "boredom", description: "Baja activación, ausencia de estímulo significativo" },
  { emoji: "😌", label: "Calma", value: "calmness", description: "Relajación, cierta estabilidad" },
  { emoji: "🤔", label: "Confusión", value: "confusion", description: "Disonancia cognitiva, falta de comprensión" },
  { emoji: "🤤", label: "Anhelo", value: "craving", description: "Deseo intenso, apetito hacia un objeto/situación" },
  { emoji: "🤢", label: "Asco", value: "disgust", description: "Rechazo ante algo percibido como sucio, contaminante o violatorio" },
  { emoji: "😢", label: "Dolor empático", value: "empathic_pain", description: "Percibir el dolor y sentir ante el sufrimiento ajeno" },
  { emoji: "😎", label: "Fascinación", value: "entrancement", description: "Atracción irresistible, deslumbramiento intenso hacia alguien o algo" },
  { emoji: "🥳", label: "Entusiasmo", value: "excitement", description: "Exaltación del ánimo y fervor apasionado ante algo que admira" },
  { emoji: "😨", label: "Miedo", value: "fear", description: "Respuesta ante amenaza concreta o percibida" },
  { emoji: "😱", label: "Horror", value: "horror", description: "Miedo combinado con asco o perturbación moral" },
  { emoji: "🧐", label: "Interés", value: "interest", description: "Orientación atencional hacia algo novedoso o complejo" },
  { emoji: "😊", label: "Alegría", value: "joy", description: "Bienestar, satisfacción positiva" },
  { emoji: "🕰️", label: "Nostalgia", value: "nostalgia", description: "Añoranza afectiva por el pasado" },
  { emoji: "😮‍💨", label: "Alivio", value: "relief", description: "Reducción de tensión tras superar una amenaza real o percibida" },
  { emoji: "🥰", label: "Enamoramiento", value: "romance", description: "Atracción afectivo-sexual con respeto y calidez" },
  { emoji: "😔", label: "Tristeza", value: "sadness", description: "Respuesta ante la pérdida o la privación" },
  { emoji: "😌", label: "Satisfacción", value: "satisfaction", description: "Cierre positivo de una meta o necesidad" },
  { emoji: "😘", label: "Deseo sexual", value: "sexual_desire", description: "Activación erótica dirigida" },
  { emoji: "🤗", label: "Compasión", value: "sympathy", description: "Preocupación orientada hacia el bienestar ajeno" },
];
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-5">
            ...
            {selectedEmotion && (() => {
              ...
              return selected ? (
                <div key={selected.value} className="flex items-center gap-3 rounded-lg border border-primary/20 bg-primary/5 p-3 animate-fade-in transition-all duration-300">
