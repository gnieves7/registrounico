  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main className="flex flex-1 flex-col lg:flex-row">
        ...
        <div
          className="relative flex min-h-[40vh] flex-1 items-end justify-center bg-cover bg-center p-8 lg:min-h-screen lg:items-center lg:justify-start lg:p-12"
          style={{ backgroundImage: `url(${danteBg})` }}
        >
          <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/40 to-transparent lg:bg-gradient-to-r lg:from-transparent lg:via-background/30 lg:to-background/95" />
          <div className="relative z-10 max-w-md text-center lg:hidden">
        ...
        {/* Right: Sections */}
        <div className="flex w-full flex-col justify-center bg-background px-6 py-10 lg:w-[480px] lg:px-10 lg:py-12 xl:w-[520px]">
          ...
          <div className="flex flex-col gap-5">
            {sections.map((section) => (
              <Card
                key={section.id}
                className={`border-2 transition-all ${section.borderColor} hover:shadow-lg`}
              >
                <CardHeader className="flex flex-row items-center gap-4 pb-2">
                  ...
                  <div>
                    ...
                    <span className="mt-0.5 inline-block rounded-full bg-muted/50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
                      {section.subtitle}
                    </span>
                  </div>
                </CardHeader>
          ...
          {/* Privacy Notice */}
          <div className="mt-8 flex items-center gap-2 rounded-lg bg-muted/50 p-3 text-center">
