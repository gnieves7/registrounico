      ...
      <main className="relative z-10 flex flex-1 flex-col">
        ...
        <section className="mx-auto w-full max-w-6xl px-6 pt-5 lg:px-10">
          <div className="rounded-xl border border-border/50 bg-card/60 backdrop-blur-sm px-5 py-4">
            <p className="text-sm italic leading-relaxed text-foreground/80 md:text-base">
          ...
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-10">
            {sections.map((section, index) => (
              ...
              >
                ...
                <span className="mt-1 flex items-center gap-2 text-xs font-medium text-muted-foreground transition-colors duration-200 group-hover:text-foreground">
