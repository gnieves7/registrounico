  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-background via-background to-muted/30">
      <main className="flex flex-1 flex-col">
        {/* Header */}
        <header className="border-b border-border/30 bg-card/80 backdrop-blur-sm px-6 py-6 lg:px-10">
          <div className="mx-auto flex max-w-5xl items-center gap-5">
            <img src={logoImg} alt="Logo ReflexionAr" className="h-16 w-16 shrink-0 object-contain md:h-20 md:w-20 drop-shadow-sm" />
            <div>
        ...
        {/* Quote - featured with serif font */}
        <section className="mx-auto w-full max-w-5xl px-6 pt-8 lg:px-10">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
            {sections.map((section, index) => (
              ...
              >
                ...
                <span className="mt-auto flex items-center gap-2 rounded-full bg-muted/60 px-4 py-2 text-xs font-medium text-muted-foreground transition-colors duration-200 group-hover:bg-muted group-hover:text-foreground">
        ...
        {/* Professional Stats */}
        <section className="mx-auto w-full max-w-5xl px-6 pb-8 lg:px-10">
