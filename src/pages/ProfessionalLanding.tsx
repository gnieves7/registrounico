          ...
          <div className="w-full max-w-md space-y-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 rounded-md px-5 py-3 text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-[0.99]"
              ...
              <p className="text-[11px] text-center" style={{ color: "#6B6B6B", fontFamily: "'DM Sans', sans-serif" }}>
                Acceso exclusivo con email y contraseña verificados por el administrador.
              </p>
            </div>
