...
const privacySections = [
  ...
  },
  {
    ...
    content:
      "La plataforma ofrece un canal opcional de notificaciones vía Telegram. La vinculación es voluntaria, requiere una acción expresa del usuario (generación de token y confirmación en chat privado) y puede revocarse en cualquier momento desde la sección «Telegram» de la plataforma o solicitándolo al profesional tratante. Los mensajes enviados son exclusivamente operativos y de acompañamiento clínico-administrativo: recordatorios de turnos, micro-tareas asignadas, premios simbólicos otorgados e informes o certificados disponibles para descarga. En ningún caso se enviarán campañas masivas, publicidad, contenidos promocionales ni mensajes de alta frecuencia. La frecuencia será limitada, proporcional y estrictamente funcional al proceso terapéutico. El profesional no accede al historial de chats del usuario fuera de esta plataforma. Los datos de vinculación (chat_id, nombre de usuario) se almacenan de forma segura y se eliminan automáticamente al revocar el consentimiento. La revocación del consentimiento no afecta la licitud del tratamiento de datos realizado con anterioridad. Para ejercer el derecho de revocación, el usuario puede desactivar la vinculación en la plataforma o contactar al profesional a los datos indicados en la sección «Responsable del tratamiento».",
  },
  {
    icon: UserCheck,
