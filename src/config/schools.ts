...
export const SCHOOL_CONFIG: Record<SchoolType, SchoolConfig> = {
  ...
  systemic: {
    ...
    authors: [
      ...
      { name: 'Gregory Bateson', works: ['Pasos hacia una ecología de la mente'] },
      { name: 'Paul Watzlawick', works: ['Teoría de la comunicación humana', 'El lenguaje del cambio'] },
      { name: 'Mara Selvini Palazzoli', works: ['Paradoja y contraparadoja', 'Los juegos psicóticos en la familia'] },
      { name: 'Michael White & David Epston', works: ['Medios narrativos para fines terapéuticos'] },
    ],
    diagnosticFramework: {
