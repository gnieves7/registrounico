...
export const MENU_BY_SCHOOL: Record<SchoolType, SchoolMenuItem[]> = {
  ...
  humanistic: [
    { id: 'home', label: 'Inicio', icon: Home, url: r('home') },
    { id: 'history', label: 'Mi Historia de Vida', icon: Sprout, url: r('history'), tooltip: 'Narrativa autobiográfica, hitos vitales y construcción de sentido personal' },
    { id: 'training', label: 'Ejercicios de Autoconciencia', icon: Circle, url: r('training'), tooltip: 'Actividades de exploración experiencial, contacto presente y crecimiento' },
    { id: 'emotional', label: 'Registro Experiencial', icon: Thermometer, url: r('emotional'), tooltip: 'Estado emocional presente, calidad del contacto y bienestar subjetivo' },
    { id: 'unconscious', label: 'Diario de Experiencias', icon: BookOpen, url: r('unconscious'), tooltip: 'Registro de experiencias significativas, emociones sentidas y momentos de contacto' },
    { id: 'alliance', label: 'Calidad del Encuentro', icon: Heart, url: r('alliance'), tooltip: 'Presencia terapéutica, empatía y autenticidad en el vínculo' },
    { id: 'timeline', label: 'Línea de Vida', icon: Leaf, url: r('timeline'), tooltip: 'Momentos cumbres, crisis existenciales e hitos de crecimiento personal' },
    { id: 'tasks', label: 'Invitaciones de Exploración', icon: Sprout, url: r('tasks'), tooltip: 'Experiencias, lecturas o ejercicios de autoconocimiento para la semana' },
    { id: 'rewards', label: 'Celebración del Crecimiento', icon: Star, url: r('rewards'), tooltip: 'Momentos de autenticidad, coraje y crecimiento reconocidos' },
    { id: 'telegram', label: 'Telegram', icon: Send, url: r('telegram') },
    { id: 'monitoring', label: 'Proceso de Crecimiento', icon: Leaf, url: r('monitoring'), tooltip: 'Evolución de las áreas de crecimiento: congruencia, sentido y contacto' },
    { id: 'appointments', label: 'Mis Encuentros', icon: Calendar, url: r('appointments'), tooltip: 'Agenda de encuentros terapéuticos' },
    { id: 'notebook', label: 'Diario Vivencial', icon: BookOpen, url: r('notebook'), tooltip: 'Espacio de escritura libre para explorar la experiencia presente' },
    { id: 'assistant', label: 'Laura — Acompañante', icon: MessageCircle, url: r('assistant') },
